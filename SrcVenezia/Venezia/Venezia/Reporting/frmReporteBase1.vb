...
Public Class frmReporteBase1
    ...
    Private Sub frmReporteBase1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "frmReporteBase1.frmReporteBase1_Load")
            gAdmin.Log.fncGrabarLogERR("Error en frmReporteBase1.frmReporteBase1_Load" & ex.Message)
        End Try
