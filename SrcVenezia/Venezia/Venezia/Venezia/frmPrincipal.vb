...
#Region "FUNCIONES ABRIR"
    ...
    Public Sub SubArirCOrdenDeCompra(ByRef pOrden As cOrdenCompra, ByRef pFrmLlamador As TemplateForm, ByVal pModo As FrmBase.EnuOPERACION)
        Dim Ventana As New frmStkOrdenCompraABM
        Dim F As Form
        Dim i As Integer
        Try
            Ventana.Text = "Orden de Compra " & pOrden.Id_OrdenDeCompra.ToString
            For i = 0 To Me.MdiChildren.Length - 1
                F = Me.MdiChildren.GetValue(i)
                If F.GetType Is Ventana.GetType Then
                    If F.Text = Ventana.Text Then
            ...
            Ventana.FrmLlamador = pFrmLlamador
            Ventana.TipoDeOperacion = pModo
            Ventana.mOrdenCompra = pOrden
            Ventana.Show()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "FrmPrincipal.SubArirCOrdenDeCompra")
            gAdmin.Log.fncGrabarLogERR("Error en frmPrincipal.SubArirCOrdenDeCompra:" & ex.Message)
        End Try
    End Sub
...
#End Region
    ...
    Private Sub RankingDeChequesPorClienteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RankingDeChequesPorClienteToolStripMenuItem.Click
        Dim Ventana As New frmTesoChkRankingxCliente
        Dim F As Form
        Dim i As Integer
        Dim Cant As Integer = 0
        Try
            ...
            Ventana.Show()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "frmPrincipal.RankingDeChequesPorClienteToolStripMenuItem_Click")
            gAdmin.Log.fncGrabarLogERR("Error en frmPrincipal.RankingDeChequesPorClienteToolStripMenuItem_Click:" & ex.Message)
        End Try
    End Sub

    Private Sub MailingFinDeDiaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MailingFinDeDiaToolStripMenuItem.Click
        Dim Ventana As New frmBatchMailingTesoFinDia
        Dim F As Form
        Dim i As Integer
        Dim Cant As Integer = 0
        Try
            ...
            Ventana.Show()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "frmPrincipal.MailingFinDeDiaToolStripMenuItem_Click")
            gAdmin.Log.fncGrabarLogERR("Error en frmPrincipal.MailingFinDeDiaToolStripMenuItem_Click:" & ex.Message)
        End Try
    End Sub

    Private Sub ConsultaDeConciliacionDeLiquidacionToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ConsultaDeConciliacionDeLiquidacionToolStripMenuItem.Click
        Dim Ventana As New frmTesoLiqConciliacionConsulta
        Dim F As Form
        Dim i As Integer
        Dim Cant As Integer = 0
        Try
            ...
            Ventana.Show()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "frmPrincipal.ConsultaDeConciliacionDeLiquidacionToolStripMenuItem_Click")
    ...
    Private Sub ConsultaDeOrdenesDeCompraToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ConsultaDeOrdenesDeCompraToolStripMenuItem.Click
        Dim Ventana As New frmStkOrdenCompraConsulta
        Dim F As Form
        Dim i As Integer
        Dim Cant As Integer = 0
        Try
            ...
            Ventana.Show()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "frmPrincipal.ConsultaDeOrdenesDeCompraToolStripMenuItem_Click")
            gAdmin.Log.fncGrabarLogERR("Error en frmPrincipal.ConsultaDeOrdenesDeCompraToolStripMenuItem_Click:" & ex.Message)
        End Try
    End Sub
End Class