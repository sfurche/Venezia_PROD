...
Public Class frmSoporte
    ...
    Private Sub btnEnviar_Click(sender As Object, e As EventArgs) Handles btnEnviar.Click
        Try
            ...
            If rtxtMje.Text.Trim = "" Then
                MsgBox("Debe escribir un mensaje para enviar...", MsgBoxStyle.Exclamation, "Mensaje vacio")
                Exit Sub
            End If

            cEmail.EnviarMailSoporte(rtxtMje.Text, gAdmin.User.Usuario.Trim)

            Me.Close()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "frmSoporte.btnEnviar_Click")
            gAdmin.Log.fncGrabarLogERR("Error en frmSoporte.btnEnviar_Click:" & ex.Message)
        End Try
    End Sub
