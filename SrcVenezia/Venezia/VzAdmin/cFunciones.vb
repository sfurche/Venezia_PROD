...
Public Class cFunciones
    ...
    Public Shared Function gFncgetDbValue(ByVal pValor As Object, ByVal pTipo As TipoDato) As String
        gFncgetDbValue = ""
    ...
    Public Shared Function gFncgetObjValue(ByVal pValor As Object, ByVal pTipo As TipoDato) As Object
    ...
    Public Shared Function gFncGetXMLvalue(ByVal pNodo As String, ByVal pKey As String, ByVal pItem As Integer) As String
    ...
    Public Shared Sub gSubGuardarFondo_registry(ByVal p_Image_Path As String, ByVal p_ImgSizeMode As Integer)
    ...
    Public Shared Function gFncGetValorFondo_Registry(ByVal p_Nombre As String) As String
    ...
    Public Shared Function gFncConvertDateToString(ByVal pFecha As Date, ByVal pFormato As String) As String
        Dim Rta As String = ""
    ...
    Public Shared Function gFncNumToText(ByVal p As Decimal) As String
    ...
    End Function
    Public Shared Function gFncDecimalToText(ByVal p As Decimal) As String
